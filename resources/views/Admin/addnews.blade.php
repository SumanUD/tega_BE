    ...
    <form method="POST" action="/admin/news/store" enctype="multipart/form-data"
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text" name="news_title" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
                <label for="textarea" class="col-4 col-form-label">News Description</label>
                <div class="col-8">
                    <textarea id="desc" name="news_description" cols="40" rows="5" required="required"
        ...
        <table class="table table-striped text-center" style="border: 2px solid #ddd !important;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/Assets/Image/news/{{ $news->news_image }}" class="rounded-circle" width="50"
                            height="50">
                    </td>
                    <td>
                        <a href="/admin/news/{{ $news->slug }}/edit" class="btn btn-warning"><i
                                class="fa-solid fa-pen"></i></a>
                        <a href="{{ url('/admin/news/' . $news->slug . '/delete') }}" class="btn btn-danger"
