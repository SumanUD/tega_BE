            ...
            <div class="card-body" style="padding: 36px 52px;">
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input id="text" name="product_id" type="hidden" class="form-control" required="required" placeholder="Please enter product name" value="{{$products['id']}}">
                        <input id="text" name="product_name" type="text" class="form-control" required="required" placeholder="Please enter product name" value="{{$products['product_name']}}">
                    ...
                    <div class="col-md-6">
                        ...
                        <img src="https://tega.codtrees.com/storage/product/{{ $products['product_image'] }}" class="avatar avatar-sm me-3" alt="Tega" style="width: 100px; height:auto">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <select id="jobtype_2"
                            ...
                            @foreach ($blogs as $blog)
                                <option value="{{ $blog['id'] }}" {{ $products['blog_cat'] == $blog['id'] ? 'selected' : '' }}>{{ $blog['blog_title'] }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="jobtype_3"
                            ...
                            @foreach ($blogs as $blog)
                                <option value="{{ $blog['id'] }}" {{ $products['article_cat'] == $blog['id'] ? 'selected' : '' }}>{{ $blog['blog_title'] }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <select id="jobtype"
                            ...
                            <option value="grinding-equipments" {{ $products['product_category'] == 'grinding-equipments' ? 'selected' : '' }}>Grinding Equipments</option>
                            <option value="screening-equipments" {{ $products['product_category'] == 'screening-equipments' ? 'selected' : '' }}>Screening Equipments</option>
                            <option value="feeding-equipments" {{ $products['product_category'] == 'feeding-equipments' ? 'selected' : '' }}>Feeding Equipments</option>
                            <option value="crushing" {{ $products['product_category'] == 'crushing' ? 'selected' : '' }}>Crushing</option>
                            <option value="job-shop" {{ $products['product_category'] == 'job-shop' ? 'selected' : '' }}>Job Shop</option>
                            <option value="construction-equipments" {{ $products['product_category'] == 'construction-equipments' ? 'selected' : '' }}>Construction Equipments</option>
                            <option value="equpment-for-steel-plants" {{ $products['product_category'] == 'equpment-for-steel-plants' ? 'selected' : '' }}>Equipment for Steel Plants</option>
                            <option value="process-plant-equipments" {{ $products['product_category'] == 'process-plant-equipments' ? 'selected' : '' }}>Process Plant Equipments</option>
                            <option value="ash-handling-equipment" {{ $products['product_category'] == 'ash-handling-equipment' ? 'selected' : '' }}>Ash Handling Equipment</option>
                            <option value="material-handling-equipment" {{ $products['product_category'] == 'material-handling-equipment' ? 'selected' : '' }}>Material Handling Equipment</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="text" name="service_contact" type="number" class="form-control"
                            required="required" placeholder="Please enter service contact" value="{{$products['service_contact']}}">
                        <span class="service_contact" style="color: red"></span>
                    </div>
                    <div class="col-md-4">
                        <label class="col-form-label" for="text">Spare Contact</label>
                        <input id="text" name="spares_contact" type="number" class="form-control" required="required" placeholder="Please enter spare contact" value="{{$products['spares_contact']}}">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea id="desc" name="product_description" cols="40" rows="5" class="form-control">{{$products['product_description']}}</textarea>
                ...
                @if ($products['variation_offer_description'])
                <?php $i = 1?>
                @foreach ($products['variation_offer_description'] as $productofferitem)
                    
                <div class="card">
                    <div class="card-body">
                        <div class="row" style="margin-top: 21px">
                            <div class="col-md-12 mb-5"><h5 style="text-align: center">Update Offer Section{{$i++}}</h5></div>
                            <div class="col-md-6">
                                <input id="variation_gallery
                                " name="variation_offer_gallery_old[]" type="file" class="form-control" accept="image/*" aria-required="true" aria-invalid="false">
                                <img src="https://tega.codtrees.com/storage/product/{{ $productofferitem['gallery_path'] }}" class="avatar avatar-sm me-3" alt="Tega" style="width: 100px; height:auto">
                            </div>
                            <div class="col-md-6">
                                <textarea id="offer_desc" name="variation_offer_description_old[]" cols="40" rows="5" required="required"class="form-control" placeholder="Please enter description">{{$productofferitem['description']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{-- ================================= Data Old Key Benefits ============================ --}}

                @if ($products['variation_key_benefits_question'])
                <?php $j = 1?>

                @foreach ($products['variation_key_benefits_question'] as $productquestion)
                    
                <div class="card">
                    <div class="card-body">
                        <div class="row" style="margin-top: 21px">
                            <div class="col-md-12 mb-5"><h5 style="text-align: center">Update Key Benefits Section {{$j++}}</h5></div>
                            <div class="col-md-6">
                                <input id="varques" name="variation_key_benefits_question_old[]" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Please enter question" value="{{$productquestion['question']}}">
                            </div>
                            <div class="col-md-6">
                                <input id="varans" name="variation_key_benefits_answer_old[]" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Please enter answer" value="{{$productquestion['answer']}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{-- =================================Data Key Old Benefits ============================ --}}
                {{-- ================================= Product Old Feature ============================ --}}

                @if ($products['variation_product_feature_title'])
                <?php $k = 1?>

                @foreach ($products['variation_product_feature_title'] as $productfeature)
                    
                <div class="card">
                    <div class="card-body">
                        <div class="row" style="margin-top: 21px">
                            <div class="col-md-12 mb-5"><h5 style="text-align: center">Update Product Feature Section {{$k++}}</h5></div>
                            <div class="col-md-6">
                                <input id="varques" name="old_pr_fea_title[]" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Please enter question" value="{{$productfeature['title']}}">
                            </div>
                            <div class="col-md-6">
                                <input id="variation_gallery
                                " name="old_pr_fea_gallery[]" type="file" class="form-control" accept="image/*" aria-required="true" aria-invalid="false">
                                <img src="https://tega.codtrees.com/storage/product/{{ $productfeature['gallery_path'] }}" class="avatar avatar-sm me-3" alt="Tega" style="width: 100px; height:auto">
                            </div>
                            <div class="col-md-6">
                                <textarea id="offer_desc" name="old_pr_fea_desc[]" cols="40" rows="5" required="required"class="form-control" placeholder="Please enter description">{{$productfeature['title']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if ($products['variation_pdf_title'])
                <?php $l = 1?>

                @foreach ($products['variation_pdf_title'] as $productpdf)
                    
                <div class="card">
                    <div class="card-body">
                        <div class="row" style="margin-top: 21px">
                            <div class="col-md-12 mb-5"><h5 style="text-align: center">Update Product PDF Section {{$l++}}</h5></div>
                            <div class="col-md-6">
                                <input id="varques" name="old_pdf_title[]" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Please enter title" value="{{$productpdf['pdf_title']}}">
                            </div>
                            <div class="col-md-6">
                                <input id="variation_gallery" name="old_pdf_file[]" type="file" class="form-control" accept="application/pdf" aria-required="true" aria-invalid="false">
                                <embed src="https://tega.codtrees.com/storage/product/{{ $productpdf['pdf_title'] }}" type="application/pdf" width="100%" height="400px" />
                            </div>                            
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#editproduct').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                data: frmData,
                url: 'http://127.0.0.1:8000/api/admin/editproductfunction',
                processData: false,
                contentType: false,
