...
@section('pageTitle', 'Edit Industry')
@section('content')
<div class="container col-md-10" style="  margin: auto;
  ...
  margin-top: 10px;
  padding: 10px;">
    <form method="POST" action="/admin/industry/{{ $industry->slug }}/update" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body" style="border-radius: 10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text" name="industry_name" type="text" class="form-control"
                        value="{{ old('industry_name', $industry->industry_name) }}" required="required">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-4 col-form-label" for="text">Current Image</label>
                <div class="col-8 text-center">
                    <img src="/Assets/Image/industry/{{ $industry->industry_image }}" class=""
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input name="industry_image" type="file" class="form-control">
                </div>
            </div>
            <div class="form-group row">
