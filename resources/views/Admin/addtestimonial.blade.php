...
<div class="container col-md-10" style="  margin: auto;
  ...
  padding: 10px;">
    ...
    <form method="POST" action="/admin/testimonial/store" enctype="multipart/form-data"
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text" name="testimonial_name" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea id="desc" name="testimonial_description" cols="40" rows="5" required="required"
        ...
        <table class="table table-striped text-center" style="border: 2px solid #ddd !important;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/Assets/Image/testimonial/{{ $testimonial->testimonial_image }}"
                            class="rounded-circle" width="50" height="50">
                    </td>
                    <td>
                        <a href="/admin/testimonial/{{ $testimonial->slug }}/edit" class="btn btn-warning"><i
                                class="fa-solid fa-pen"></i></a>
                        <a href="{{ url('/admin/testimonial/' . $testimonial->slug . '/delete') }}"
                            class="btn btn-danger" onClick="confirmation(event)"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
        </table>
