...
<div class="container col-md-10" style="  margin: auto;
  ...
  margin-top: 10px;
  padding: 10px;">
    <form method="POST" action="/admin/slider/{{ $slider->slug }}/update" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body" style="border-radius: 10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="text" name="slider_title" type="text" class="form-control"
                        value="{{ old('slider_title', $slider->slider_title) }}" required="required">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea id="desc" cols="40" rows="5" class="form-control" required="required"
                        name="slider_description">{{ old('slider_description', $slider->slider_description) }} </textarea>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-4 col-form-label" for="text">Current Image</label>
                <div class="col-8 text-center">
                    <img src="/Assets/Image/slider/{{ $slider->slider_image }}" class=""
